...
#define INSTRUCTION_LIST \
    ...
    /* RV32A atomics */ \
    X(lr_w,      "00010 0 0 00000 ????? 010 ????? 01011 11", TYPE_R, imm0); \
    X(sc_w,      "00011 0 0 ????? ????? 010 ????? 01011 11", TYPE_R, imm0); \
    X(amoadd_w,  "00000 0 0 ????? ????? 010 ????? 01011 11", TYPE_R, imm0); \
    X(amoswap_w, "00001 0 0 ????? ????? 010 ????? 01011 11", TYPE_R, imm0); \
    X(amoxor_w,  "00100 0 0 ????? ????? 010 ????? 01011 11", TYPE_R, imm0); \
    X(amoand_w,  "01100 0 0 ????? ????? 010 ????? 01011 11", TYPE_R, imm0); \
    X(amoor_w,   "01000 0 0 ????? ????? 010 ????? 01011 11", TYPE_R, imm0); \
    X(amomin_w,  "10000 0 0 ????? ????? 010 ????? 01011 11", TYPE_R, imm0); \
    X(amomax_w,  "10100 0 0 ????? ????? 010 ????? 01011 11", TYPE_R, imm0); \
    X(amominu_w, "11000 0 0 ????? ????? 010 ????? 01011 11", TYPE_R, imm0); \
    X(amomaxu_w, "11100 0 0 ????? ????? 010 ????? 01011 11", TYPE_R, imm0); \
